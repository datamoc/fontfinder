...
class AdvancedFontViewerApp:
    ...
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("FontFinder Advanced GUI - Visualiseur de polices avec SVG")
    ...
    def _refresh_list(self):
        ...
        if self.filter_glyphs.get():
            info_text = f"FontFinder Advanced ({svg_status}): {shown} / {total} polices compatibles"
        else:
            info_text = f"FontFinder Advanced ({svg_status}): {total} polices trouvées"
