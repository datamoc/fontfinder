#!/usr/bin/env python3
"""
FontFinder - Reusable GUI widget component for embedding in other applications.
...
class FontPickerWidget(ttk.Frame):
    """
    Reusable FontFinder widget that can be embedded in other applications.
    ...
    def _refresh_list(self):
        ...
        if self.filter_glyphs.get() and sample_text:
            # Utiliser FontFinder pour filtrer par texte
