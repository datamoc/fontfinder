#!/usr/bin/env python3
"""
FontFinder - Command-line interface.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="FontFinder - Discover and analyze system fonts",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  fontfinder                           # List all fonts
  fontfinder --gui                     # Launch graphical interface
  fontfinder --gui-advanced            # Launch advanced GUI with SVG support
  fontfinder --gui-i18n                # Launch internationalized GUI (10 languages)
  fontfinder --text "🌷😀"             # Fonts supporting emojis
  fontfinder --types TTF,OTF           # Only TrueType and OpenType fonts
  fontfinder --random --max 10        # 10 random fonts
  fontfinder --text "äöü ß" --paths   # German fonts with file paths
        """
    )
